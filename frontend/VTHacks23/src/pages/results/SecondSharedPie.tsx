            ...
            {!isAboveMediumScreens && (
                <div className="mx-auto w-[200px] pb-72">
                    <div className="mt-10 relative group text-center mb-8">
                        <span className="text-white text-3xl bg-left-bottom bg-gradient-to-r from-orange-400 to-orange-400 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out italic mt-10">
                            {title}
                        </span>
                    </div>
                    <div>
