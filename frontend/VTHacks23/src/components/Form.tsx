...
function Form() {
  ...
  return (
    <>
      <div className="relative pb-24 bg-home-bg bg-cover bg-no-repeat h-[41rem] z-[-50] bg-red-800 ">
        <div className="absolute top-0 left-0 w-full h-full bg-black opacity-50 z-[-5]"style={{ pointerEvents: 'none' }} />
